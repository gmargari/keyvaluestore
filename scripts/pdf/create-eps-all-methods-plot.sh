...
file_imm="${statsfolder}/immediate.log";     every_imm="2"
file_rng="${statsfolder}/rangemerge.log";    every_rng="10"
file_gp2="${statsfolder}/geometric-p-2.log"; every_gp2="2"
file_geo="${statsfolder}/geometric-r-3.log"; every_geo="2"
file_cl2="${statsfolder}/cassandra-l-2.log"; every_cl2="2"
file_log="${statsfolder}/geometric-r-2.log"; every_log="2"
file_cas="${statsfolder}/cassandra-l-4.log"; every_cas="2"
file_nom="${statsfolder}/nomerge.log";       every_nom="2"

ensure_file_exist $file_imm $file_rng $file_gp2 $file_geo $file_cl2 $file_log $file_cas $file_nom

tmpfile="$(mktemp)"
cat $file_imm $file_rng $file_gp2 $file_geo $file_cl2 $file_log $file_cas $file_nom > $tmpfile
...
#    set grid xtics ytics mxtics mytics # set grid [no]xtics [no]ytics
    ...
    '$file_cl2' using (mb2gb(\$1)):(sec2min(\$2)) every $every_cl2::1 title '$title_cl2' with $style_cl2, \
    ...
    '$file_cl2' using (mb2gb(\$1)):(sec2min(\$5)) every $every_cl2::1 title '$title_cl2' with $style_cl2, \
    ...
    '$file_cl2' using (mb2gb(\$1)):(sec2min(\$9 + \$10)) every $every_cl2::1 title '$title_cl2' with $style_cl2, \
    ...
    '$file_cl2' using (mb2gb(\$1)):(mb2gb(\$11 + \$12)) every $every_cl2::1 title '$title_cl2' with $style_cl2, \
