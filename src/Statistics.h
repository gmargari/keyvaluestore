 ...
 *           for Rangemerge, create and insert streams in DiskStore for new
 *           files, etc)
 * Tmem:     time for string comparisons and string copies (strcmp & strcpy)
 */

// NOTE: add new field -> update global_stats_init() and stats_sanity_check()
typedef struct {
